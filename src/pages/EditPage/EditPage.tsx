...
export const EditPage = () => {
  ...
  const inputFields: InputField[] = [
    {
      ...
      validationConditions: { min: 4, max: 20, errorMessage: 'Title should not' },
    },
    {
      name: 'author',
      label: 'Author',
      ...
      validationConditions: { min: 4, max: 15, errorMessage: "Author's name should not" },
    },
    {
      name: 'category',
      label: 'Category',
    ...
    },
    {
      ...
      required: true,
      value: String(bookDetails.isbn),
      validationConditions: { min: 9, max: 10, errorMessage: 'ISBN should not' },
    },
  ];
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>, field: InputField) => {
    if (field.validationConditions) {
      const error =
        validator({ value: e.target.value, conditions: field.validationConditions }) || null;
