  ...
  },
  {
    ...
    list: [
      { name: 'React', description: 'A JavaScript library for building user interfaces.' },
      {
        ...
        description: 'A set of bindings for using React Router in web applications.',
      },
      { name: 'UUID', description: 'A library to generate unique identifiers.' },
      {
        name: 'classnames',
        description: 'A utility for conditionally joining class names together.',
      },
      ...
      { name: 'SCSS', description: 'A CSS preprocessor used for styling the application.' },
      {
        ...
        description: 'A component for showing success messages after changes.',
      },
